      ...
      <div className="mx-auto w-full">
        ...
        <section className="mb-6 grid grid-cols-2 gap-3 lg:grid-cols-3 xl:grid-cols-6" aria-label="Billing KPIs">
          {[
            ...
            { label: 'Projected margin', value: summary?.projectedInrMarginPercent === null ? '—' : summary ? `${summary.projectedInrMarginPercent.toFixed(1)}%` : '—', icon: Gauge, tone: summary && summary.projectedInrMarginPercent !== null && summary.projectedInrMarginPercent < 0 ? 'text-[#8d3028] bg-[#fff1ef]' : 'text-[#176b52] bg-[#eef9f4]' },
