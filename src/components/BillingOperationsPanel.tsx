    ...
    <main className="app-content min-h-full px-4 py-5 sm:px-6 lg:px-8" aria-busy={loading}>
      <div className="mx-auto w-full">
        ...
        <section className="mb-6 grid grid-cols-2 gap-3 lg:grid-cols-3 xl:grid-cols-6" aria-label="Billing KPIs">
          {[
            { label: 'Billed revenue', value: summary ? moneyPaise(summary.inrBilledPaise) : '—', icon: CircleDollarSign, tone: 'text-[#8b5e00] bg-[#fff8e8]' },
            { label: 'Collected', value: summary ? moneyPaise(summary.inrCollectedPaise) : '—', icon: Wallet, tone: 'text-[#176b52] bg-[#eef9f4]' },
            { label: 'Outstanding', value: summary ? moneyPaise(summary.inrOutstandingPaise) : '—', icon: Landmark, tone: 'text-[#8b5e00] bg-[#fff8e8]' },
            { label: 'Monthly cost', value: summary ? moneyPaise(summary.totalInrCostPaise) : '—', icon: Server, tone: 'text-[#656b6b] bg-[#f4f5f5]' },
            { label: 'Projected gross profit', value: summary ? moneyPaise(summary.projectedInrGrossProfitPaise) : '—', icon: TrendingUp, tone: summary && summary.projectedInrGrossProfitPaise < 0 ? 'text-[#8d3028] bg-[#fff1ef]' : 'text-[#176b52] bg-[#eef9f4]' },
            { label: 'Margin', value: summary ? `${summary.estimatedMarginPercent.toFixed(1)}%` : '—', icon: Gauge, tone: 'text-[#176b52] bg-[#eef9f4]' },
