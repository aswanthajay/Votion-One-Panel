        ...
        <div className="app-body">
          ...
          <Suspense fallback={<RouteLoading />}>
            <Routes>
              ...
              <Route path={VIEW_PATHS.instances} element={activeRole === 'admin' ? <DashboardContent pageTitle="Virtual Machines" onOpenModal={handleOpenModal} workspaceName="All service locations" /> : <ClientPanelRoute onOpenModal={handleOpenModal} workspaceConnectionId={workspaceScope.connectionId || undefined} />} />
              <Route path={VIEW_PATHS['instances-qemu']} element={activeRole === 'admin' ? <DashboardContent pageTitle="QEMU Virtual Machines" typeFilter="qemu" onOpenModal={handleOpenModal} workspaceName="All service locations" /> : <ClientPanelRoute filter="qemu" onOpenModal={handleOpenModal} workspaceConnectionId={workspaceScope.connectionId || undefined} />} />
              <Route path={VIEW_PATHS['instances-lxc']} element={activeRole === 'admin' ? <DashboardContent pageTitle="LXC Containers" typeFilter="lxc" onOpenModal={handleOpenModal} workspaceName="All service locations" /> : <ClientPanelRoute filter="lxc" onOpenModal={handleOpenModal} workspaceConnectionId={workspaceScope.connectionId || undefined} />} />
